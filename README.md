# genpark-multi-touch-ad-attribution-shapley-resolver-skill
...
**genpark-multi-touch-ad-attribution-shapley-resolver-skill** is a deterministic, zero-dependency Python skill engineered for intelligent merchant operations, supply chain logistics routing, and customer retention analytics.

> **Executive Capability**: Multi-touch ad attribution Shapley value & ROAS contribution resolver (Triple Whale)
...
result = client.resolve_shapley_attribution()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-multi-touch-ad-attribution-shapley-resolver-skill": {
      "command": "python",
      "args": ["/path/to/genpark-multi-touch-ad-attribution-shapley-resolver-skill/mcp_server.py"]
    }
  }
}
```
